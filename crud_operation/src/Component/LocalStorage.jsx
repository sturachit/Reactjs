...
export const LocalStorage = () => {
  ...
  const HandleSubmit = (e) => {
    console.log(e.target);
    setArray([...array, info]);
    localStorage.setItem("UserInfo", JSON.stringify([...array, info]));
  };
    ...
    <>
      <div>
        ...
        <form action="" className="text-center mt-5 text-primary">
          ...
          <br />
          <button type="submit" onClick={HandleSubmit} className=" btn btn-primary p-2 px-5 text-center bg-primary fw-bold text-light border-0 "> Submit </button>
        </form>
      </div>
      <hr />
